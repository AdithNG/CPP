...
//Date: 2/29/2022
//Description: This is part of the project 2
...
public:
  ...
  void RaceTitle(){
    cout << "**************************************************" << endl;
    cout << "         RRR     AA    CCCC   EEEE   RRR     " << endl;
    cout << "         R  R   A  A   C      E      R  R    " << endl;
    cout << "         RRR    AAAA   C      EEEE   RRR     " << endl;
    cout << "         R R    A  A   C      E      R R     " << endl;
    cout << "         R  R   A  A   CCCC   EEEE   R  R    " << endl;
    cout << "**************************************************" << endl;
  }
private:
